...
print('(h) more images')
img = im2double(plt.imread('person_1.jpg'))
#skin = skinDetection(ndata, sdata, skin_K, skin_n_iter, skin_epsilon, theta, img)
#plt.imsave('person_1_skin.png', skin)
img = im2double(plt.imread('person_2.jpg'))
#skin = skinDetection(ndata, sdata, skin_K, skin_n_iter, skin_epsilon, theta, img)
#plt.imsave('person_2_skin.png', skin)
img = im2double(plt.imread('alps.jpg'))
skin = skinDetection(ndata, sdata, skin_K, skin_n_iter, skin_epsilon, theta, img)
plt.imsave('alps_skin.png', skin)
img = im2double(plt.imread('minion_landscape.jpg'))
skin = skinDetection(ndata, sdata, skin_K, skin_n_iter, skin_epsilon, theta, img)
plt.imsave('minion_landscape_skin.png', skin)
