...
class city_scapes(Dataset):
    def __init__(self, datapath, transform):
        self.size_threshold = 900  # images should be at least 900 pixels
    ...
    def image_dims(self, image):
        ...
        return image.size[0] * image.size[1] >= self.size_threshold
    ...
    def get_labels(self, filename):
        ...
        for name in filename:
            id_ = int(
                name[-9:-4]
            )  # Get last part of filename which reveals label of image
